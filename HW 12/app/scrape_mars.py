...
def featured_image(browser):
    ...
    img = img_scrape.select_one("figure.lede a img")
...
def twitter_weather(browser):
    ...
    browser.visit(url)
    html = browser.html
    weather_scrape = BeautifulSoup(html, "html.parser")
    tweet_attributes = {"class": "tweet", "data-name": "Mars Weather"}
    mars_weather_tweet = weather_scrape.find("div", attrs=tweet_attrs)
...
def scrape_hemisphere(html_text):
    ...
    hemi_scrape = BeautifulSoup(html_text, "html.parser")
    try:
